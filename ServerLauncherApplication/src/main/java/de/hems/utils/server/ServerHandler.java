...
public class ServerHandler {
    ...
    public void startNewInstance(ListenerAdapter.ServerName name, int allocatedMemoryMB, FileType.SERVER jarFile, FileType.PLUGIN[] plugins) throws Exception {
        ...
        pluginList.addAll(List.of(FileType.PLUGIN.CORE_PROTECT, FileType.PLUGIN.WORLDEDIT, FileType.PLUGIN.CHUNKY, FileType.PLUGIN.WORLD_GUARD, FileType.PLUGIN.SIMPLE_VOICECHAT_PAPER));
        switch (name) {
            case SURVIVAL -> {
